...
<center><h3> Rojgar Aur <font color="red">Puppy</font> </h3></center><br>

<div class="container"  >
  		<div class="row">
			<div class="col-sm-6" >
				<div class="card" style="width:300px">
					<img class="card-mg-top" src="puppies/D4.jpg" alt="Rojgar Aur" height="400px" style="width:100%">
					<div class="card-body">
						<center><H5 class="card-title"> Rojgar Aur </H5> 
						<p>Rs.25000</p></center>
					</div>
				</div>
			</div>
			<div class="col-sm-6 text-bold" >
					...
					We have all type of pure breed Rojgar Aur puppies available:<br>
					<br>
