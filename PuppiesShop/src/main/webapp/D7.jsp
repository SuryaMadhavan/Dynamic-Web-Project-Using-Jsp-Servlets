...
<center><h3> Rottweiler <font color="red">Puppy</font> </h3></center><br>

<div class="container"  >
  		<div class="row">
			<div class="col-sm-6" >
				<div class="card" style="width:300px">
					<img class="card-mg-top" src="puppies/D7.jpg" alt="Rottweiler" height="400px" style="width:100%">
					<div class="card-body">
						<center><H5 class="card-title"> Rottweiler </H5> 
						<p>Rs.30000</p></center>
					</div>
				</div>
			</div>
			<div class="col-sm-6 text-bold" >
					...
					We have all type of pure breed Rottweiler puppies available:<br>
					<br>
